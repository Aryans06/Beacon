...
// Mock data for the dashboard to simulate real-time updates
const initialIncidents = [
  { id: 1, type: "Weapon Detected", location: "Lobby Entrance", time: "12:44:01", severity: "critical" },
  { id: 2, type: "Guest SOS (Translated)", location: "Room 412", time: "12:42:30", severity: "warning", desc: "Medical issue reported. NLP extracted: 'heart pain'." },
      ...
      <main className={styles.workspace}>
        ...
        <aside className={`${styles.panel} ${styles.feedPanel}`}>
          <div className={styles.panelHeader}>
            ...
            <span className="badge badge-critical" style={{ fontSize: '0.6rem' }}>3 Active</span>
          </div>
        ...
        <section className={`${styles.panel} ${styles.mapPanel}`}>
          ...
          <div className={styles.mapContainer}>
            {/* Simulated floorplan graphic */}
            <div className={styles.blueprint}>
              {/* Plotting the critical pin for Lobby Entrance */}
              <div className={`${styles.mapPin} ${styles.pinCritical}`} style={{ top: '80%', left: '50%' }} />
              {/* Plotting the warning pin for Room 412 (simulated area) */}
              <div className={`${styles.mapPin} ${styles.pinWarning}`} style={{ top: '30%', left: '20%' }} />
              
              {/* Simulated safe evacuation route */}
              <svg style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none' }}>
                <path d="M 20% 30% L 20% 80% L 10% 80%" stroke="var(--success)" strokeWidth="2" strokeDasharray="4 4" fill="none" />
              </svg>
            </div>

            {/* Float overlay for map legend */}
        ...
        <aside className={`${styles.panel} ${styles.detailsPanel}`}>
          ...
          <div className={styles.detailsContent}>
            ...
            <div className={styles.detailGroup}>
              ...
              <div className={styles.detailValue} style={{ color: 'var(--critical)', fontWeight: 600 }}>Weapon Detected</div>
              <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', marginTop: '4px' }}>Camera: Lobby-04</div>
            </div>

            <div className={styles.detailGroup}>
              <div className={styles.detailLabel}>Gemini Confidence Score</div>
              <div className={styles.detailValue} style={{ fontSize: '1.5rem', fontFamily: 'var(--font-mono)', color: 'var(--accent)' }}>98.2%</div>
            </div>

            <div className={styles.detailGroup}>
              <div className={styles.detailLabel}>AI Recommended Action</div>
